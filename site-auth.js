...
function getEyeOpenIcon() {
    return `
        <svg class="password-toggle-icon w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
...
function getEyeClosedIcon() {
    return `
        <svg class="password-toggle-icon w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20C5 20 1 12 1 12a20.51 20.51 0 0 1 5.17-6.17"></path>
            <path d="M1 1l22 22"></path>
            <path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a20.2 20.2 0 0 1-2.67 3.77"></path>
...
function initPasswordToggles() {
    ...
    toggles.forEach((button) => {
        ...
        const syncState = () => {
            ...
            button.innerHTML = isVisible ? getEyeClosedIcon() : getEyeOpenIcon();
        };
